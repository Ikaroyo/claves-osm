    ...
    var __webpack_modules__ = [
        ...
        (__unused_webpack_module, exports, __w_pdfjs_require__) => {
          ...
          function getDocument(t) {
            ...
            const d = t.verbosity,
              ...
              O =
                t.filterFactory ||
                new DefaultFilterFactory({ docId: s, ownerDocument: w });
        ...
        (t, e, s) => {
          ...
          class AnnotationEditorUIManager {
            ...
            #nt() {
              document.addEventListener("copy", this.#z);
              document.addEventListener("cut", this.#X);
              document.addEventListener("paste", this.#$);
            }
            #at() {
              document.removeEventListener("copy", this.#z);
            ...
            copy(t) {
              ...
              const e = [];
              for (const t of this.#V) t.isEmpty() || e.push(t.serialize());
              0 !== e.length &&
          ...
          e.OptionalContentConfig = class OptionalContentConfig {
            ...
            constructor(t) {
              ...
              if (null !== t) {
                ...
                if ("OFF" === t.baseState)
                  for (const t of this.#Rt.values()) t._setVisible(a, !1);
                for (const e of t.on) this.#Rt.get(e)._setVisible(a, !0);
                for (const e of t.off) this.#Rt.get(e)._setVisible(a, !1);
            ...
            isVisible(t) {
              ...
              if ("OCG" === t.type) {
                ...
                return this.#Rt.get(t.id).visible;
              }
              if ("OCMD" === t.type) {
            ...
            getGroups() {
              return this.#Rt.size > 0 ? (0, i.objectFromMap)(this.#Rt) : null;
            }
            getGroup(t) {
              return this.#Rt.get(t) || null;
            }
            getHash() {
              if (null !== this.#Mt) return this.#Mt;
              const t = new n.MurmurHash3_64();
              for (const [e, s] of this.#Rt) t.update(`${e}:${s.visible}`);
              return (this.#Mt = t.hexdigest());
            }
          };
        },
        (t, e, s) => {
        ...
        (t, e, s) => {
          ...
          class AnnotationEditorLayer {
            #Lt;
            #Nt = !1;
            #Bt = this.pointerup.bind(this);
            #jt = this.pointerdown.bind(this);
            #Ut = new Map();
            #qt = !1;
            #Wt = !1;
            #Gt;
            ...
            constructor(t) {
              ...
              this.#Gt.addLayer(this);
            }
            get isEmpty() {
              return 0 === this.#Ut.size;
            }
            updateToolbar(t) {
              this.#Gt.updateToolbar(t);
            }
            updateMode(t = this.#Gt.getMode()) {
              this.#Ht();
            ...
            addInkEditorIfNeeded(t) {
              if (!t && this.#Gt.getMode() !== i.AnnotationEditorType.INK)
                return;
              if (!t)
            ...
            setEditingState(t) {
              this.#Gt.setEditingState(t);
            }
            addCommands(t) {
              this.#Gt.addCommands(t);
            }
            enable() {
            ...
            setActiveEditor(t) {
              this.#Gt.getActive() !== t && this.#Gt.setActiveEditor(t);
            }
            enableClick() {
              this.div.addEventListener("pointerdown", this.#jt);
              this.div.addEventListener("pointerup", this.#Bt);
            }
            disableClick() {
              this.div.removeEventListener("pointerdown", this.#jt);
              this.div.removeEventListener("pointerup", this.#Bt);
            }
            attach(t) {
              this.#Ut.set(t.id, t);
            }
            ...
            add(t) {
              ...
              t.onceAdded();
              this.#Gt.addToAnnotationStorage(t);
            }
            moveEditorInDOM(t) {
              this.#Lt?.moveElementInDOM(this.div, t.div, t.contentDiv, !0);
            }
            addOrRebuild(t) {
            ...
            deserialize(t) {
              switch (t.annotationType) {
                case i.AnnotationEditorType.FREETEXT:
                  return a.FreeTextEditor.deserialize(t, this, this.#Gt);
                case i.AnnotationEditorType.INK:
                  return r.InkEditor.deserialize(t, this, this.#Gt);
              }
              return null;
            }
            #Vt(t) {
            ...
            setSelected(t) {
              this.#Gt.setSelected(t);
            }
            toggleSelected(t) {
              this.#Gt.toggleSelected(t);
            }
            isSelected(t) {
              return this.#Gt.isSelected(t);
            }
            unselect(t) {
              this.#Gt.unselect(t);
            }
            ...
            pointerdown(t) {
              ...
              this.#qt = !0;
              const s = this.#Gt.getActive();
              this.#Nt = !s || s.isEmpty();
            }
            drop(t) {
              const e = t.dataTransfer.getData("text/plain"),
                s = this.#Gt.getEditor(e);
              if (!s) return;
              t.preventDefault();
            ...
            destroy() {
              this.#Gt.getActive()?.parent === this &&
                this.#Gt.setActiveEditor(null);
              for (const t of this.#Ut.values()) {
                this.#Lt?.removePointerInTextLayer(t.contentDiv);
                t.setParent(null);
                t.isAttachedToDOM = !1;
              ...
              this.div = null;
              this.#Ut.clear();
              this.#Gt.removeLayer(this);
            }
            #Ht() {
              this.#Wt = !0;
              for (const t of this.#Ut.values()) t.isEmpty() && t.remove();
              this.#Wt = !1;
            }
            render({ viewport: t }) {
              this.viewport = t;
              ...
              for (const t of this.#Gt.getEditors(this.pageIndex)) this.add(t);
              this.updateMode();
            }
            update({ viewport: t }) {
              this.#Gt.commitOrRemove();
              this.viewport = t;
        ...
        (t, e, s) => {
          ...
          class FreeTextEditor extends a.AnnotationEditor {
            ...
            #Kt = this.editorDivFocus.bind(this);
            #Yt = this.editorDivInput.bind(this);
            ...
            constructor(t) {
              ...
              this.#se = t.fontSize || FreeTextEditor._defaultFontSize;
            }
            static initialize(t) {
            ...
            #ie(t) {
              const setFontsize = (t) => {
                  ...
                  this.translate(0, -(t - this.#se) * this.parentScale);
                  this.#se = t;
                  this.#ae();
                },
                e = this.#se;
            ...
            getInitialTranslation() {
              ...
              return [
                ...
                -(FreeTextEditor._internalPadding + this.#se) * t,
              ];
            }
            rebuild() {
              super.rebuild();
            ...
            enableEditMode() {
              if (!this.isInEditMode()) {
                ...
                this.editorDiv.addEventListener("focus", this.#Kt);
                this.editorDiv.addEventListener("blur", this.#$t);
                this.editorDiv.addEventListener("input", this.#Yt);
              }
            }
            disableEditMode() {
              if (this.isInEditMode()) {
                ...
                this.div.setAttribute("aria-activedescendant", this.#te);
                this.div.draggable = !0;
                this.editorDiv.removeEventListener("keydown", this.#Jt);
                this.editorDiv.removeEventListener("focus", this.#Kt);
                this.editorDiv.removeEventListener("blur", this.#$t);
                this.editorDiv.removeEventListener("input", this.#Yt);
            ...
            render() {
              ...
              s.fontSize = `calc(${this.#se}px * var(--scale-factor))`;
              s.color = this.#Qt;
        ...
        (t, e, s) => {
          ...
          class InkEditor extends n.AnnotationEditor {
            ...
            #Ne(t, e) {
              ...
              this.#Le();
              let s;
              if (1 !== this.currentPath.length) s = this.#Be();
              else {
                const i = [t, e];
            ...
            canvasPointerdown(t) {
              if (0 === t.button && this.isInEditMode() && !this.#me) {
                this.setInForeground();
                t.preventDefault();
            ...
            #Ue(t) {
              ...
              this.canvas.removeEventListener("pointermove", this.#de);
              this.canvas.removeEventListener("pointerup", this.#pe);
              this.canvas.addEventListener("pointerdown", this.#fe);
              setTimeout(() => {
                this.canvas.removeEventListener("contextmenu", this.#he);
              }, 10);
            ...
            setDimensions(t, e) {
              const s = Math.round(t),
                i = Math.round(e);
              if (this.#ye === s && this.#ve === i) return;
              this.#ye = s;
              this.#ve = i;
              this.canvas.style.visibility = "hidden";
              if (this.#oe && Math.abs(this.#oe - t / e) > 0.01) {
                e = Math.ceil(t / this.#oe);
                this.setDims(t, e);
              }
              const [n, a] = this.parentDimensions;
              this.width = t / n;
            ...
            #Ve(t, e, s, i) {
              ...
              for (const l of this.paths) {
                ...
                for (let n = 0, c = l.length; n < c; n++) {
                  ...
                  r.push(g, m, b, A, _, y);
                  this.#ze(p, f, g, m, b, A, _, y, 4, o);
                }
                n.push({ bezier: r, points: o });
              }
              return n;
            }
            #ze(t, e, s, i, n, a, r, o, l, c) {
          ...
          class TextWidgetAnnotationElement extends WidgetAnnotationElement {
            ...
            render() {
              ...
              if (this.renderForms) {
                ...
                let r =
                  i.formattedValue || this.data.textContent?.join("\n") || null;
                  ...
                  this.data.actions?.Keystroke &&
                    s.addEventListener("beforeinput", (t) => {
                      ...
                      const { data: s, target: i } = t,
                        { value: n, selectionStart: a, selectionEnd: r } = i;
                      let l = a,
                        c = r;
                      switch (t.inputType) {
            ...
            static render(t) {
              ...
              for (const t of e) {
                ...
                if (Array.isArray(n))
                  for (const e of n) {
                    e.style.zIndex = c++;
                    AnnotationLayer.#Je(e, t.id, s, o);
                  }
                else {
                  n.style.zIndex = c++;
                  e instanceof PopupAnnotationElement
                    ? s.prepend(n)
                    : AnnotationLayer.#Je(n, t.id, s, o);
                }
              }
            ...
            e.SVGGraphics = r = class {
              ...
              _makeTilingPattern(t) {
                ...
                const x = this.svg,
                  ...
                  P = this.svgFactory.create(m - p, b - f);
                this.svg = P;
